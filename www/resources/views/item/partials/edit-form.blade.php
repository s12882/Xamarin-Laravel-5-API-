    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                {!! Form::model($model,array('url' => $postAction, 'method'=>$actionMethod,'class'=>'form-horizontal', 'id' => "raport-form")) !!}
                {!! Form::hidden('id', null) !!}
                <div class="form-body">
                  <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-offset-2 col-lg-5 col-md-7">
                            ...
                            <a class="btn red red-stripe btn-outline" href="{{route('raport.index')}}">Powróć</a>
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
...
@stop
@section('page-js')
@include('raport.partials.edit-page-scripts')
@stop